...
ggarrange(rls_summary_vp, rls_means_plot_wt, rls_summary_regression,
          nrow = 3, ncol = 1)
```
...
rls_ttest$Signif <- abs(rls_ttest$p.value.bonf.adjust) < 0.05
...
#    theme(strip.text = element_blank())
  ...
  # Create dotplot plot; use means with more than 30 data points
