...
aus_map <- ggplot() +
  ...
  # Arrows to depict ocean currents
  geom_curve(aes(x = 155, y = -10, xend = 155, yend = -40),
             col = "red",
             curvature = -0.5,
  ...
  geom_curve(aes(x = 120, y = -41, xend = 140, yend = -41),
             col = "blue",
             curvature = -0.3,
             arrow = arrow(type = "closed", length = unit(0.2, "inches")),
             lineend = "round",
  ...
  # labels
  geom_text(aes(x = 165, y = -25, label = "EAC"), fontface = "bold") +
  geom_text(aes(x = 130, y = -40, label = "LZC"), fontface = "bold") +
  ...
  # labels
  geom_text(aes(x = 115, y = -10, label = "NA"), fontface = "bold") +
  geom_text(aes(x = 111, y = -32, label = "WA"), fontface = "bold") +
  geom_text(aes(x = 130, y = -35, label = "SA"), fontface = "bold") +
...
```{r}
ggplot(rls_summary[abs(dLat) > 0.5], aes(x = guild,  fill = limit)) +
  geom_bar(position = "dodge") +
  labs(x = "") +
  theme_bw()

chisq.test(table(rls_summary$guild, rls_summary$limit))
```
